...
export function organizationSchema() {
  return {
    ...
    image: `${BUSINESS.url}/images/Norelle%20Handblended%20Perfumes.png`,
    description:
      "Norelle is a luxury perfume and natural attar brand based in Ahmedabad, India. We handcraft premium fragrances using 100% natural ingredients — oud, rose, sandalwood, musk, and rare botanicals — and deliver free across Ahmedabad.",
    foundingDate: "2016",
    foundingLocation: {
      "@type": "Place",
