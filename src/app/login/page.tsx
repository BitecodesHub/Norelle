        ...
        <div className="absolute inset-0 flex flex-col justify-end p-14">
          ...
          >
            ...
            <h2 className="font-serif text-5xl text-white font-light leading-[1.1] mb-4">
              The art of<br />
              <span className="italic text-gold">timeless scent</span>
            </h2>
            <p className="text-white/60 font-sans text-sm leading-relaxed max-w-xs">
              Every bottle tells a story of tradition, patience, and craftsmanship passed down through generations.
            </p>
          </motion.div>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12 bg-parchment relative">
        ...
        >
          ...
          <div className="mb-10">
            ...
            <p className="text-latte font-sans text-xs tracking-[0.3em] uppercase">Welcome back</p>
          </div>
          ...
          <div className="bg-white border border-tan rounded-2xl p-8 space-y-6 shadow-card">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              ...
              <div className="flex justify-end">
                <span className="text-xs text-latte font-sans cursor-default select-none">Forgot password?</span>
              </div>
